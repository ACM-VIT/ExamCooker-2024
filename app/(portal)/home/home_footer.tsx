...
function HomeFooter() {
  return (
    <footer className="flex flex-col sm:flex-row justify-between items-center pt-1 pb-1 mx-20% bg-[#C2E6EC] dark:bg-[#0C1222] border-t border-t-[#82BEE9] dark:border-t-[#3BF4C7] px-4 sm:px-8">
