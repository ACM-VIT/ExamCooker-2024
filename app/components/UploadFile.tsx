...
const UploadFile = ({
  ...
  const { getRootProps, getInputProps } = useDropzone({
    onDrop: (acceptedFiles: File[]) => {
      ...
      setFileTitles((f) => [
        ...f,
        ...acceptedFiles.map((file) => removePdfExtension(file.name)),
      ]);
      setIsDragging(false);
    },
          ...
          <div className="grid grid-cols-2 gap-4 mb-4 place-content-center">
            ...
            <div>
              ...
              >
                ...
                <option value="TAA2">TAA2</option>
                <option value="TBB2">TBB2</option>
                <option value="TCC2">TCC2</option>
                <option value="TDD2">TDD2</option>
                <option value="TCC1">TCC1</option>
                <option value="TCC2">TCC2</option>
          ...
          {files.length > 0 && (
            <div className="flex flex-col gap-2 w-[100%]">
              {files.map((_, index) => (
                <div
                  key={index}
                  className="text-gray-700 flex items-center text-xs w-full"
                >
